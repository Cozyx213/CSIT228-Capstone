...
public class Executive extends User {
    ...
    public Executive(int userId, String firstName, String lastName, String username, String passwordHash) {
        super(userId, firstName, lastName, username, passwordHash, Role.EXECUTIVE);
    }
